define("kirin/utils/1.0.0/array-debug", [ "./carray-debug" ], function(require, exports, module) {
    var CArray = require("./carray-debug");
...
define("kirin/utils/1.0.0/array-debug", [ "./carray-debug" ], function(require, exports, module) {
    ...
    var CArray = Helper.dblPrototype(Array.prototype, function(obj) {
        this.arr = obj;
    });
    Helper.augment(CArray, {
        /**
     * 循环数组(对象)
